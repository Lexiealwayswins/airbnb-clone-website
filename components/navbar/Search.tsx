  ...
  return (
    <div>
      ...
      <div className={showFilter ? 'block' : 'hidden'}>
        ...
        >
          <div className="flex flex-row items-center justify-between text-center">
            <div className="px-6 font-semibold text-sm hover:text-lg">Where</div>
            <div className="flex-1 px-6 border-x-[1px] font-semibold hidden sm:block text-sm hover:text-lg">Date</div>
            <div className="flex flex-row items-center gap-3 pl-6 pr-2 text-gray-600 text-sm hover:text-lg">
              <div className="hidden sm:block">
                Who
              </div>
